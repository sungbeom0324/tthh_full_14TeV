...
//    auto infile = "/data1/users/stiger97/HLLHC_tthh/DATA/inc/"+channel+"/Events/tag_*.root";
    auto infile = "/data1/users/stiger97/HLLHC_tthh/nnpdf31_5fs/inc/"+channel+"/Events/tag_*.root";
...
//                  .Filter("nGenbQ == 4")  // CAUTION. THIS OPTION IS ONLY TTBB
    ...
    // MODIFY!!
    df5.Snapshot(treename, outdir+ "nnpdf31_" + channel + ".root", variables); 
