...
void ana_os2l(std::string channel, std::string outdir="../skimmed/"){
    ...
    auto infile = "/data1/users/stiger97/HLLHC_tthh/DATA/inc/"+channel+"/Events/tag_1_*.root"; // analysis //
...
//                  .Filter("nGenbQ == 4")  // CAUTION. THIS OPTION IS ONLY TTBB
    ...
    // MODIFY!!
    df5.Snapshot(treename, outdir+ "test_os2l_0911_deleteit" + channel + ".root", variables); 
