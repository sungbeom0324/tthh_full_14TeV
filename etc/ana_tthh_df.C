...
void ana_tthh_df(std::string channel, std::string outdir="./samples1/"){
    ...
    auto infile = "/data1/users/stiger97/HLLHC_tthh/DATA/semi/"+channel+"/Events/tag_*.root"; // modify //
...
//    auto df6 = df5.Filter("isMatchable > 0"); 
    ...
    // MODIFY!!
    df5.Snapshot(treename, outdir+ "SEMI_OSDL_0817_" + channel + ".root", variables); 
