...
conv1 = Conv2D(8, (2, 2), kernel_initializer='lecun_uniform', activation='relu', name='jets_conv0')(input_layer)
batch_norm1 = BatchNormalization()(conv1)
conv2 = Conv2D(16, (2, 2), activation='relu', use_bias=False, padding='same')(batch_norm1)
batch_norm2 = BatchNormalization()(conv2)
conv3 = Conv2D(32, (2, 2), activation='relu', use_bias=False)(batch_norm2)
